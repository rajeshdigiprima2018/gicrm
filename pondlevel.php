...
<!-- 						<th>
						...
						<th>Pond Level (foot)</th>
						<th>Pond Level (percent) </th>
						<th>Pond Inventory</th>
						<th>Stream Level</th>
                        <th>ACTION</th>
                    </tr>
                </thead>
				...
				<?php
				$result = mysqli_query($conn,"SELECT * FROM ftppondlevel");
					$i=1;
				...
				<tr id="<?php echo $row["id"]; ?>">
					...
					<td><?php echo $row["pond_Level_(foot)"]; ?></td>
					<td><?php echo $row["pond_Level_(percent)"]; ?></td>
					<td><?php echo $row["pond_Inventory"]; ?></td>
					<td><?php echo $row["stream_Level"]; ?></td>
					<td>
